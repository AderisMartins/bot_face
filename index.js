...
async function roboFace() {
  ...
  const browser = await puppeteer.launch({ headless: false, waitUntil: 'load', timeout: 0, args: [
  ...
  for (const id of ids) {
    try {
      ...
      const botaoAdd = await page.$x('/html/body/div[1]/div/div[1]/div/div[3]/div/div/div[1]/div[1]/div/div/div[1]/div[2]/div/div/div/div[4]/div/div/div[1]/div/div') || "";
      if (botaoAdd !== "") {
      ...
      const botaoMsg = await page.$x('/html/body/div[1]/div/div[1]/div/div[3]/div/div/div[1]/div[1]/div/div/div[1]/div[2]/div/div/div/div[4]/div/div/div[2]/div/div') || "";
      if (botaoMsg !== "") {
      ...
      const inputMsg = await page.$x('/html/body/div[1]/div/div[1]/div/div[5]/div/div[1]/div[1]/div[1]/div/div/div/div/div/div/div[2]/div/div[2]/form/div/div[3]/div[2]/div[1]/div/div/div[2]/div/div[2]/div');
